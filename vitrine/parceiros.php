...
/* O menu da plataforma é um componente compartilhado (menu-plataforma.php),
 * usado também por podcast.php e curso.php — edite os itens lá. */
...
/* Barra de navegação: estilos no componente menu-plataforma.php */
/* cabeçalho */
...
@media(max-width:640px){.parceiro-corpo{padding:20px 18px}}
</style>
</head>
<body>
<?php
$MENU_ATIVO = 'Nossos Parceiros';
include __DIR__ . '/menu-plataforma.php';
?>
